...
import es.upm.miw.iwvg_devops.code.DecimalStreamWithFunctionalProgramming;
...
class DecimalStreamWithFunctionalProgrammingTest {
    ...
    @Test
    void testSize() {
        Assertions.assertEquals(4, new DecimalStreamWithFunctionalProgramming().size(this.stream));
    }
